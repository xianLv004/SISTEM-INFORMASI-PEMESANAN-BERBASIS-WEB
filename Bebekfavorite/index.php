...
if (isset($_GET["transaksi"])) {
    ...
    if (!isset($_GET["search"])) {
        $menu = ambil_data("SELECT * FROM menu ORDER BY id_menu ASC");
    } else {
...
<body class="bg-dark">
    ...
    <div id="dropdown-menu" class="container-fluid position-fixed float-start bg-dark text-white w-auto vh-100" style="display: none; z-index: 1; top: 50px;">
       <ul>
                    <br>
            <li style= list-style:circle><a class="text-decoration-none p-2 h5 text-light " href="index.php" > MENU</a></li><br>
            <?php if (isset($_SESSION["akun-admin"])) { ?>
            <li style= list-style:circle><a class="text-decoration-none p-2 h5 text-light" href="index.php?pesanan">PESANAN</a></li><br>
            <li style= list-style:circle><a class="text-decoration-none p-2 h5 text-light" href="index.php?transaksi">TRANSAKSI</a></li>
            <?php } ?>
        </ul>
    </div>
